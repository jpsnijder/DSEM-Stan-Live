...
set_cmdstan_path(file.path("C:/ProgramData/cmdstan-2.33.1"))
...
# should become a source function
# this is for the within structure of the Hamaker et al., 2023 book chapter.
# it is the same across all 6 models.
...
Then we can set some general parameters that will be the same across the simulations:
